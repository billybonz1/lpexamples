...
editableItems['h1'] = ['color', 'font-size', 'background-color', 'font-family', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom'];
editableItems['h2'] = ['color', 'font-size', 'background-color', 'font-family', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom'];
editableItems['h3'] = ['color', 'font-size', 'background-color', 'font-family', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom'];
editableItems['h4'] = ['color', 'font-size', 'background-color', 'font-family', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom'];
editableItems['h5'] = ['color', 'font-size', 'background-color', 'font-family', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom'];
editableItems['h6'] = ['color', 'font-size', 'background-color', 'font-family', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom'];
editableItems['p'] = ['color', 'font-size', 'background-color', 'font-family', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom'];
editableItems['strong'] = ['color', 'font-size', 'background-color', 'font-family', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom'];
editableItems['a.btn, button.btn, a'] = ['border-radius', 'font-size', 'background-color', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom'];
...
editableItems['a, a:hover, li, span, .footer a, .color-white, .color-red-1, .color-green-1, .color-black-1, .color-orange-1, .color-orange-2'] = ['color', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom'];
editableItems['div, .item,.bg.bg1, .bg.bg2, .item.header.header1, .item.header.header2, .item.header.header3, .item.header.header4, .item.header.header5, .item.header.header6, .item.header.header7, .item.header.header8, .item.header.header9, .item.header.header10, .item.header.header11, .item.header.header12, .item.header.header13, .item.header.header14, .item.header.header15, .item.header.header16, .item.header.header17, .item.header.header18, .item.header.header19, .item.header.header20, .item.header.header21, .item.header.header22, .item.header.header23, .item.header.header24, .item.header.header25, .item.header.header26, .item.header.header27, .item.header.header28, .item.header.header29, .item.header.header30, .item.header.header31, .item.header.header32, .item.header.header33, .item.header.header34, .item.header.header35, .item.header.header36, .item.header.header37, .item.header.header38, .item.header.header39, .item.header.header40, .item.header.header41, .item.header.header42, .item.header.header43, .item.header.header44'] = ['background-image', 'background-color', 'background', 'padding-top', 'padding-bottom', 'padding-left', 'padding-right', 'margin-left', 'margin-right', 'margin-top', 'margin-bottom'];
editableItems['a, a:hover, p, span, li, ul, ol, h1, h2, h3, h4, h5, h6'] = ['background', 'background-color', 'color', 'font-size', 'font-family', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom', 'margin-left', 'margin-right', 'margin-top', 'margin-bottom', 'text-align'];
...
editableItemOptions['h1 : font-family'] = ['default', 'Raleway', 'Helvetica', 'Arial', 'Times New Roman'];
editableItemOptions['h2 : font-family'] = ['default', 'Raleway', 'Helvetica', 'Arial', 'Times New Roman'];
editableItemOptions['h3 : font-family'] = ['default', 'Raleway', 'Helvetica', 'Arial', 'Times New Roman'];
editableItemOptions['h4 : font-family'] = ['default', 'Raleway', 'Helvetica', 'Arial', 'Times New Roman'];
editableItemOptions['h5 : font-family'] = ['default', 'Raleway', 'Helvetica', 'Arial', 'Times New Roman'];
editableItemOptions['h6 : font-family'] = ['default', 'Raleway', 'Helvetica', 'Arial', 'Times New Roman'];
editableItemOptions['p : font-family'] = ['default', 'Lato', 'Helvetica', 'Arial', 'Times New Roman'];


var editableContent = ['.editContent', '.navbar a', 'button', 'a.btn', '.footer a:not(.fa)', '.tableWrapper', 'input', 'a', '.icon-list .link', 'h1' ,'h2','h3','h4','h5','h6','p','span','strong','li','div', 'input' ];
		...
		beforeStop: function(event, ui){
			...
			if( ui.item.find('.frameCover').size() == 0 ) {
				...
				if( ui.item.find('iframe').size() > 0 ) {//iframe thumbnails
					...
					ui.item.find('iframe').uniqueId();
					ui.item.find('iframe').height(theHeight+"px");
					ui.item.find('iframe').css('background', '#ffffff url(images/loading-2.GIF) 50% 50% no-repeat');
		...
		for( x=0; x<_Elements.elements[key].length; x++ ) {
			...
			if( _Elements.elements[key][x].thumbnail == null ) {//we'll need an iframe
				...
				if( _Elements.elements[key][x].sandbox != null ) {
					...
					newItem = $('<li class="element '+niceKey+'"><p class="element-title-builder">'+_Elements.elements[key][x].title+'</p><img src="'+_Elements.elements[key][x].thumbnail+'" data-srcc="'+_Elements.elements[key][x].url+'" data-height="'+_Elements.elements[key][x].height+'"></li>')
					...
					$(this).contents().find( pageContainer + ' '+editableContent[i] ).hover( function(){
						...
						if( this.tagName == 'SMALL' || this.tagName == 'A' || this.tagName == 'LI' || this.tagName == 'SPAN' || this.tagName == 'B' || this.tagName == 'I' || this.tagName == 'TT' || this.tageName == 'CODE' || this.tagName == 'EM' || this.tagName == 'STRONG' || this.tagName == 'SUB' || this.tagName == 'BUTTON' || this.tagName == 'LABEL' || this.tagName == 'P' || this.tagName == 'H1' || this.tagName == 'H2' || this.tagName == 'H2' || this.tagName == 'H3' || this.tagName == 'H4' || this.tagName == 'H5' || this.tagName == 'H6' ) {
							...
							$('#editContentModal #contentToEdit').redactor({
								buttons: ['html', 'bold', 'italic', 'deleted', 'rtl'],
								focus: true,
